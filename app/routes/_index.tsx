    ...
    <>
      ...
      <div className="mt-8 flex flex-col items-center justify-center text-center md:mt-16 z-10 relative">
        ...
        <ul className="mt-12 space-y-2">
          <li>
            I'm a <Link to="/software">staff software engineer</Link> building
            AI agents at Inscribe
          </li>
          <li>
          ...
          <li className="h-4" />
          <li>
            New album with Christina Dolphin & Brian McGrath{" "}
            <a href="https://album.dangurney.net">out now!</a>
          </li>
        </ul>
