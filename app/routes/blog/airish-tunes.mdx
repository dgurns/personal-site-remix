...
**TL;DR:** I built [an app](https://airishtunes.pages.dev) that picks a random Irish tune each day and uses AI to generate an image for it. The app uses all kinds of fancy new tech from Cloudflare, and in this post I explain what _The Edge™_ means.
...
<img src="/images/eavesdropper-ai.png" width="300" className="mt-8 rounded overflow-hidden" />
