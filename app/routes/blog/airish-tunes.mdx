...
**TL;DR:** I built [an app](https://airishtunes.pages.dev) that picks a random Irish tune each day and uses AI to generate an image for it. The app uses a bunch of new tech from Cloudflare, and in this post I explain what "the edge" means.
